...
<head>
  ...
  <div>
    <form>
    <p><CENTER><button><a href="/dream/index.php?view=newpacient" class="btn btn-info"><i class='fa fa-male'></i>  REGRESAR</button></a></CENTER></p>
    </form>
  </div>
  </section>
...
<body >
  <section class="container">
    <div class="login">
      <h1>Odontologia SMILEMED</h1>
      <form method="post">
        <p><input type="text" name="txtdni" value="" placeholder="Ingrese su cedula"></p>
        ...
        <p class="submit"><input type="submit" name="entrar" value="INGRESAR"></p>
      </form>
    </div>
  </section>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    if (mysqli_num_rows($usuario) > 0) {
                        while ($row = mysqli_fetch_row($usuario)) {
                            ...
                            {
                              header("location:index.php?view=buscarpacientecedulaodontologia");
                    ...
                    echo "<center><br>Usuario no registrado<br></center>";
                }
            }
